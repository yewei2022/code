...
#气象数据2016-2023
f_dir = r'D:\YEWEI\project\traffic\202310-公路交通一张图\2.气象数据\2016-2023.csv'
...
# #添加位置信息，法二
# path_sta = r'D:\YEWEI\project\traffic\data\sta_info.txt'
...
# #写入文件
# info.to_csv(r'D:\YEWEI\project\traffic\data\fog_year_avg_days.txt',
#                     index = True,sep=' ',na_rep=32700)


#%% branch2 计算 有降水且日最低气温≤0的年均日数
...
info = pd.concat([sta,fog_avg2],axis=1,join="inner") #和80个站点信息取交集
#写入文件
info.to_csv(r'D:\YEWEI\project\traffic\data\tmp0_year_avg_days.txt',
                    index = True,sep=' ',na_rep=32700)
