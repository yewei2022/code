...
for j in range(0,7):
    ...
    # 再去掉一些地名
    a0.loc[a0["站名"].isin(["富泉中海8组", "唐家西南", "小堡丁家" , "富乡富和",
                          "安乐锣锅坪", "前域千锋","马烈大水塘",
                          "唐家庄子","唐家大岭","三交大山上",
                          "富庄镇同义村5组","清溪同心","马烈新华烂泥三湾",
                          "富林滨湖社区","富林富塘","晒经炮台","富泉鸣鹿",
                          "安乐印版山","河南盐井","坭美和爱3组","万工",
                          "大树大维","富乡乡富和村","九襄大木"]),"站名"]= " "
    ...
    leftlon, rightlon, lowerlat, upperlat = (102.15,103.15,29,29.85) #!!!换县
