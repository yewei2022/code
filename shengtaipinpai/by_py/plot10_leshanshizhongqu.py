...
for j in range(0,7):
    ...
    a0.loc[a0["站名"].isin(["牟子两河口电站","白马石龙","通江檀木嘴",
                          "大佛山珍水库","安谷泊滩","安谷大龙","全福龙头沟水库",
                          "清风", "普仁普仁村",
                          "苏稽","水尾水星","白腊亮窗口","大石互助",
                          "分水木格倒","银顶","水尾"]),"站名"]= " "
    ...
    leftlon, rightlon, lowerlat, upperlat = (103.45, 104.1, 29.4, 29.85) #!!!换县
    ...
    # a0 = a0.drop([23])    
    a0 = a0[~a0['站名'].isin(['苏稽牛头堰'])]
    
    a1 =a0.reset_index(inplace = False)
    
    a1.loc[:,'纬度'] = a1['纬度']+0.01
